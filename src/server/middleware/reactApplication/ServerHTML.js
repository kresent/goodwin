...
import HTML from '../../../shared/root/HTML';
...
function ServerHTML(props) {
  ...
  // если зашли сразу на страницу с детальной информацией, то загружаем css и js синхронно
  const isDetailInfoPage = /\d+$/.test(props.url);
  ...
  const headerElements = removeNil([
    ...
    ifElse(
      (process.env.BUILD_FLAG_IS_DEV === 'true' || isDetailInfoPage) &&
        clientEntryAssets &&
        clientEntryAssets.css
