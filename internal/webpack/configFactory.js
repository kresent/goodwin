...
import FileListPlugin from './FileListPlugin';
/**
 ...
 * @param  {String} buildOptions.target - The bundle target (e.g 'clinet' || 'server').
 * @param  {Boolean} buildOptions.optimize - Build an optimised version of the bundle?
 * @param  {String} buildOptions.productionPrefix - prefix for router
 *
  ...
  let webpackConfig = {
    ...
    resolve: {
      ...
      alias: {
        ...
        leaflet_css: path.resolve(
          appRootDir.get(),
          './node_modules/leaflet/dist/leaflet.css'
        ),
        swiper_css: path.resolve(
          appRootDir.get(),
          './node_modules/swiper/dist/css/swiper.min.css'
        ),
        roboto_css: path.resolve(
          appRootDir.get(),
          './node_modules/roboto-npm-webfont/style.css'
        ),
        ptsans_css: path.resolve(
          appRootDir.get(),
          './node_modules/ptsans-npm-webfont/style.css'
        ),
      },
    },
    ...
    plugins: removeNil([
      ...
      new webpack.EnvironmentPlugin({
        ...
        PRODUCTION_PREFIX: buildOptions.productionPrefix,

        CORDOVA: isCordova,
      }),

      // Анализ бандла по объему модулей
      new BundleAnalyzerPlugin({
        analyzerMode: isClient && isProd ? 'static' : 'disabled',
        openAnalyzer: false,
      }),
