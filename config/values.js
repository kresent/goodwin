...
const values = {
  ...
  disableSSR: EnvVars.bool('CORDOVA', false),
  ...
  htmlPage: {
    ...
    defaultTitle: 'Homeapp',
    description: 'Новый безопасный сервис покупки и продажи квартир в Москве',
  },
  ...
  buildOutputPath: EnvVars.bool('CORDOVA', false) ? './cordova/www' : './build',
  ...
  serviceWorker: {
    // Enabled?
    enabled: EnvVars.bool('CORDOVA', false),
    // Service worker name
    fileName: 'sw.js',
  ...
  bundles: {
    client: {
      ...
      outputPath: EnvVars.bool('CORDOVA', false)
        ? './cordova/www'
        : './build/client',

      // What is the public http path at which we must serve the bundle from?
      webPath: EnvVars.bool('CORDOVA', false) ? '' : '/client/',
